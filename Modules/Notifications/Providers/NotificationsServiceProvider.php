 ...
 * Notifications automatisees (email/SMS/WhatsApp).
 *
 * Tant que le Feature Flag 'notifications' n'est pas actif (config/features.php,
...
class NotificationsServiceProvider extends ServiceProvider
{
    ...
    {
        return Feature::active('notifications');
    }
}
