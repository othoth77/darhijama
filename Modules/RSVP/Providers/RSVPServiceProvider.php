...
namespace Modules\RSVP\Providers;
 ...
 * Confirmation de presence des invites.
 *
 * Tant que le Feature Flag 'rsvp' n'est pas actif (config/features.php,
 ...
 */
class RSVPServiceProvider extends ServiceProvider
{
    protected string $name = 'RSVP';

    protected string $nameLower = 'rsvp';
